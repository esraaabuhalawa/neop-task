<template>
    <router-link :to="{name:'product-details',params:{id: 1}}" class="h-100 mb-3 product-card text-decoration-none">
        <div class="text-center p-2">
            <div class="position-relative">
                <div class="product-image mb-3 position-relative">
                <div class="img-container-1">
                      <div class="img-container">
                    <img src="/images/image-11.png" alt="product name">
                </div>
                </div>
            </div>
            ...
            <div class="product-desc">
                <h5 class="card-title">Booster Roasted Coffee</h5>
                <p>Amir Samantha</p>
                <div class="d-flex justify-content-center star">
                    <rating-component :rating="3" />
                </div>
            </div>
        </div>
    </router-link>
